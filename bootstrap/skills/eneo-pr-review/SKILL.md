...
9. Just before returning the final comment, call `eneo_review_run_complete` with
   ...
   not complete the review). In the current schema, `generated` means the review
   comment was generated by the model; Hermes posts it after this run returns.
   Then return only the final GitHub comment. Do not expose private
